...
CREATE USER 'admin'@'sistema-curriculo-unesp-6605.d.aivencloud.com' IDENTIFIED BY '123@mudar';
GRANT ALL PRIVILEGES ON banco_de_vaga.* TO 'admin'@'sistema-curriculo-unesp-6605.d.aivencloud.com' WITH GRANT OPTION;
FLUSH PRIVILEGES;

CREATE USER 'viewer'@'sistema-curriculo-unesp-6605.d.aivencloud.com' IDENTIFIED BY '123@mudar';
GRANT SELECT ON banco_de_vaga.* TO 'viewer'@'sistema-curriculo-unesp-6605.d.aivencloud.com';
FLUSH PRIVILEGES;
